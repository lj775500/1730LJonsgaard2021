...
using LJonsgaard2E1;
namespace LJonsgaard2E1UnitTest
{
    [TestClass]
    public class LogicalOperationsUnitTests
    {
        ...
        {
            Assert.IsTrue(LogicalOperations.q05(false, 0, 1));
        }
        [TestMethod]
        ...
        {
            Assert.IsTrue(LogicalOperations.q06(false, 0, 1));
        }
        [TestMethod]
        ...
        [TestMethod]
        public void TestQ10ValidCounter()
        {
