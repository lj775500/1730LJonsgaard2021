<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LJonsgaard2h1._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                 <asp:Label ID="Label4" runat="server" Text="4) DateTime.AddDays(90): " Enabled="False"></asp:Label>
            ...
            <div class="form-group" id="DateCalculationsButton">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox9a" runat="server" Width="60px">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox9b" runat="server" Width="60px">12/12/2012</asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox10a" runat="server" Width="60px">1/13/2013</asp:TextBox>
                <asp:TextBox ID="TextBox10b" runat="server" Width="60px">12/12/2012</asp:TextBox>
                <asp:TextBox ID="TextBox10Result" runat="server" Enabled="False"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Button ID="DateCalculationButton" runat="server" Text="Date Calculations" OnClick="Button1_Click" />
         </div> 
          </div> 
            <div class="row">
     <div class="col-md-6">
        ...
        <div class="form-group">
           ...
           <asp:TextBox ID="TextBox11Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           <asp:Label ID="Label12" runat="server" Text="2) Remove/Insert: "></asp:Label>
           <asp:TextBox ID="TextBox12" runat="server">cater</asp:TextBox>
           <asp:TextBox ID="TextBox12Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           ...
           <asp:TextBox ID="TextBox13Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           <asp:Label ID="Label14" runat="server" Text="4) PadLeft: "></asp:Label>
           <asp:TextBox ID="TextBox14" runat="server">123.45</asp:TextBox>
           <asp:TextBox ID="TextBox14Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           <asp:Label ID="Label15" runat="server" Text="5) Replace: "></asp:Label>
           <asp:TextBox ID="TextBox15" runat="server">(651) 385-6300</asp:TextBox>
           <asp:TextBox ID="TextBox15Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           ...
           <asp:TextBox ID="TextBox16Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           ...
           <asp:TextBox ID="TextBox17Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           ...
           <asp:TextBox ID="TextBox18Result" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
</div>
       <div class="form-group">
           <asp:Label ID="Label19" runat="server" Text="9) LastIndexOf/Substring: "></asp:Label>
           <asp:TextBox ID="TextBox19" runat="server" Width="150px">111 1st St, Lake City, MN 55041</asp:TextBox>
           <asp:TextBox ID="TextBox19Result" runat="server" Enabled="False" ReadOnly="True" Width="60px"></asp:TextBox>
</div>
       <div class="form-group">
           <asp:Label ID="Label20" runat="server" Text="10) StringBuilder.Append: "></asp:Label>
           <asp:Label ID="Label20Result" runat="server" Enabled="False" Text="[Label20Result]" Visible="False"></asp:Label>
           <br />
           <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <asp:Button ID="stringCalculationsbutton" runat="server" OnClick="stringCalculationsbutton_Click" Text="String Calculations Button" />
</div>
        </div>
